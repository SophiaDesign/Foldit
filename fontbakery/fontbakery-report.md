...
* ⚠ **WARN** The following glyphs have jaggy segments:
	* colonmonetary (U+20A1): L<<164.0,595.0>--<164.0,220.0>>/L<<164.0,220.0>--<224.0,595.0>> = 9.090276920822312 and uni20BA (U+20BA): L<<364.0,559.0>--<364.0,530.0>>/L<<364.0,530.0>--<363.0,559.0>> = 1.9749340108819595 [code: found-jaggy-segments]
 ...
 * Adieresis (U+00C4): L<<382.0,0.0>--<381.0,208.0>> and 159 more. [code: found-semi-vertical]
